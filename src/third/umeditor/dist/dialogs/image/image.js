...
//                }
        ...
        close: function ($img) {
            ...
            $img.css({
                ...
                if ( $(this).parent().remove().hasClass("edui-image-upload-item") ) {
                    ...
                    //Upload.updateView();
                    //UploadBase64
                    UploadBase64.showCount--;
                    UploadBase64.updateView();
                }
        ...
        createImgBase64$w: function ( file, fn) {
            //实例化file reader对象
            var reader = new FileReader();
            reader.onload = function (e) {
                fn( this.result );
    ...
    callback: function (editor, $w, url, state) {
            ...
            if (state == "SUCCESS") {
                ...
                if ($(".edui-image-upload2", $w).length < 1) {
                    ...
                    UploadBase64.render(".edui-image-content", 2).config(".edui-image-upload2");
    ...
    var UploadBase64 = {
        ...
        submit: function (callback) {
            ...
            $(me.dialog).delegate( ".edui-image-file", "change", function ( e ) {
                ...
                Base.createImgBase64$w(e.target.files[0], function (data) {
                    Base.callback(me.editor, me.dialog, data, "SUCCESS");
                });
/*
...
*/
                ...
                //$(this).parent()[0].submit();
                UploadBase64.updateInput( input );
                me.toggleMask("Loading....");
                callback && callback();
            ...
            if (!UM.browser.ie9below) {
                me.dialog.find('.edui-image-content').on('drop',function (e) {
                    ...
                    $.each(fileList, function (i, f) {
                        if (/^image/.test(f.type)) {
                            //Base.createImgBase64(img, f, me.dialog);
                            Base.createImgBase64$w(f, function(data) {
                                Base.callback(me.editor, me.dialog, data, "SUCCESS");
                            });
                            /*
                            //创建图片的base64
